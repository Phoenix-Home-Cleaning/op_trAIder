...
# ---------------------------------------------------------------------------
# Module path compatibility – prevent dual loading as 'backend.utils.exceptions'
# ---------------------------------------------------------------------------
import sys as _sys

_backend_path = "backend.utils.exceptions"
if _backend_path not in _sys.modules:
    _sys.modules[_backend_path] = _sys.modules[__name__] 