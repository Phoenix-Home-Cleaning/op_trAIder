...
app = None  # will be imported lazily inside fixtures
...
TEST_ENV = {
    ...
    "BCRYPT_ROUNDS": "12",  # Institutional-grade default rounds
    # Allow relaxed configuration validation during initial module import
    "CONFIG_VALIDATION_RELAXED": "true", 
...
def auth_headers() -> Dict[str, str]:
    ...
    payload = {
        ...
        "username": "test_trader",
        "role": "trader",
        "permissions": ["trading", "portfolio_management"],
        "iat": int(time.time()),
    }
